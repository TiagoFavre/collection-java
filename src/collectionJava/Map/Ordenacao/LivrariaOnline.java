package collectionJava.Map.Ordenacao;
...
public class LivrariaOnline {
	...
	//atributos
	  ...
	  public static void main(String[] args) {
	    ...
	    livrariaOnline.adicionarLivro("https://amzn.to/3PmYFnb", new Livro("Caixa de Passaros - Bird Box: Nao Abra os Olhos", "Josh Malerman", 19.99d ));
